...
This folder contains necessary files for evaluating LLMs on the OpinionQA-XL dataset. 
...
This directory provides scripts to evaluate LLMs on validation files for tasks proposed in the associated work. It contains a script to generate LLM responses, and two scripts to evaluate the generated responses on either predictive or generative tasks, as described in the paper.
